...
| 프로젝트명 | SubsCheck |
| --- | --- |
| 개발기간 | 2023년 09월 18일 ~ 2023년 10월 20일 |
| 개발환경 | Springboot 3.1.3 |
| 언어 | Java 17 |
| 사용기술 | Java mail, JPA, Tymeleaf, Springboot valid |
| 프로젝트 소개 | 청약 및 빌링 조회 프로그램은 고객이 청약(구독, 계약 등)과 관련된 정보를 쉽게 확인하고 빌링(요금 청구) 정보를 관리할 수 있는 소프트웨어 도구입니다 |
